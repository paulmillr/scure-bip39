import { entropyToMnemonic, generateMnemonic, mnemonicToEntropy, mnemonicToSeed, mnemonicToSeedSync, validateMnemonic, } from '../esm/index.js';
...
describe('BIP39', () => {
    ...
    describe('Mnemonic validation', () => {
        should('accept valid menomics', () => {
            deepStrictEqual(validateMnemonic('jump police vessel depth mutual idea cable soap trophy dust hold wink', englishWordlist), true);
            deepStrictEqual(validateMnemonic('koala óxido urbe crudo momia idioma boina rostro títere dilema himno víspera', spanishWordlist), true);
            deepStrictEqual(validateMnemonic('grunhido nevasca turbo coeso listagem galinha baronesa refugiar teclado cumprir fragata vinco', portugueseWordlist), true);
        });
        should('reject invalid menomics', () => {
            deepStrictEqual(validateMnemonic('asd', englishWordlist), false);
            deepStrictEqual(validateMnemonic(generateMnemonic(englishWordlist, 128), spanishWordlist), false);
        });
    });
    ...
    describe('Mnemonic to seed', () => {
        describe('Without passphrase', () => {
            const MENMONIC = 'koala óxido urbe crudo momia idioma boina rostro títere dilema himno víspera';
            const SEED = hexToBytes('e9dc495a155c2c5b577847874323853efc11e2379cc25fdcd26f3ad2ecca8b05d2a0e995fb6738dbcf65760e571863e0e8f518b5626b7865ac74f2ab814c050f');
            describe('Sync', () => {
        ...
        describe('With passphrase', () => {
            ...
            const SEED = hexToBytes('c54939df37bf94ab65973c6c1b8e5eaf855dc4ab200698961c398685714c99f9d9e5c8518769619ba606bdaf5254d4ef34c0789089a2e4f21e357a1aae906f9d');
            describe('Sync', () => {
                should('recover the right seed', () => {
    ...
    describe('BIP39-lib vectors', () => {
        function testVector(description, wordlist, password, v, i) {
            ...
            should(`for ${description} (${i}), ${entropy}`, async () => {
                ...
                deepStrictEqual(entropyToMnemonic(hexToBytes(entropy), wordlist), mnemonic, 'entropyToMnemonic');
        ...
        for (let i = 0; i < VECTORS.japanese.length; i++) {
            testVector('Japanese', japaneseWordlist, '㍍ガバヴァぱばぐゞちぢ十人十色', VECTORS.japanese[i], i);
        }
        ...
        should('UTF8 passwords', () => {
            for (const [_, mnemonic, seed] of VECTORS.japanese) {
                ...
                deepStrictEqual(toHex(mnemonicToSeedSync(mnemonic, password)), seed, 'mnemonicToSeedSync normalizes passwords');
                deepStrictEqual(toHex(mnemonicToSeedSync(mnemonic, normalizedPassword)), seed, 'mnemonicToSeedSync leaves normalizes passwords as-is');
            }
        });
        should('generateMnemonic can vary entropy length', () => {
            deepStrictEqual(generateMnemonic(englishWordlist, 160).split(' ').length, 15, 'can vary generated entropy bit length');
        });
        should('validateMnemonic', () => {
            deepStrictEqual(validateMnemonic('sleep kitten', englishWordlist), false, 'fails for a mnemonic that is too short');
            deepStrictEqual(validateMnemonic('sleep kitten sleep kitten sleep kitten', englishWordlist), false, 'fails for a mnemonic that is too short');
            deepStrictEqual(validateMnemonic('abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon about end grace oxygen maze bright face loan ticket trial leg cruel lizard bread worry reject journey perfect chef section caught neither install industry', englishWordlist), false, 'fails for a mnemonic that is too long');
            deepStrictEqual(validateMnemonic('turtle front uncle idea crush write shrug there lottery flower risky shell', englishWordlist), false, 'fails if mnemonic words are not in the word list');
            deepStrictEqual(validateMnemonic('sleep kitten sleep kitten sleep kitten sleep kitten sleep kitten sleep kitten', englishWordlist), false, 'fails for invalid checksum');
        });
    });
});
